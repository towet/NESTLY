// functions/src/location/locationSuggestions.ts
...
// Create the function with v2 syntax
export const locationSuggestions = onRequest(
  { 
    timeoutSeconds: 30,
    memory: '256MiB',
    minInstances: 0
  ...
  async (request: Request, response: Response) => {
    ...
    try {
      ...
      const result = await client.placeAutocomplete(autoCompleteRequest);
